...
@click.option('--attributes', help="comma separated key/value pairs to use as attributes")
@click.option('--json', help="Raw json state to use for setting. Overrides any other state values provided.")
